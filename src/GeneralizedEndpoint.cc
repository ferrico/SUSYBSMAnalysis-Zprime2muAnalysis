...
GeneralizedEndpoint::GeneralizedEndpoint(){
  ...
  //[-2.4, -2.1]
  _Correction[0][0] = -0.025; _CorrectionError[0][0] = 0.096; //-180,-60
  _Correction[0][1] =  -0.15; _CorrectionError[0][1] = 0.086; //-60,60
  _Correction[0][2] =  0.023; _CorrectionError[0][2] = 0.092; //60,180
  //[-2.1, -1.2]                                                                                           
  _Correction[1][0] =  -0.075; _CorrectionError[1][0] = 0.043;
  _Correction[1][1] =  -0.072;  _CorrectionError[1][1] = 0.05;
  _Correction[1][2] =  -0.034; _CorrectionError[1][2] = 0.043;
  //[-1.2, 0.]
  ...
  //[1.2, 2.1]
  _Correction[4][0] =  0.051; _CorrectionError[4][0] = 0.04;
  _Correction[4][1] =  0.0066; _CorrectionError[4][1] = 0.042;
  _Correction[4][2] =  0.086; _CorrectionError[4][2] = 0.06;
  //[2.1, 2.4]
  _Correction[5][0] =  -0.38; _CorrectionError[5][0] = 0.078;
  _Correction[5][1] =  -0.41; _CorrectionError[5][1] = 0.073;
  _Correction[5][2] =  0.16;  _CorrectionError[5][2] = 0.068;

//   [-1.2, 0.]
//   _Correction[2][0] =  -0.019;      _CorrectionError[2][0] = 0.033;
//   _Correction[2][1] =  -0.0066;      _CorrectionError[2][1] = 0.035;
//   _Correction[2][2] =  -0.019;      _CorrectionError[2][2] = 0.042;
//   [-0., 1.2]
//   _Correction[3][0] =  0.046;      _CorrectionError[3][0] = 0.036;
//   _Correction[3][1] =  0.065;      _CorrectionError[3][1] = 0.035;
//   _Correction[3][2] =  0.025;      _CorrectionError[3][2] = 0.036;
...
//   while (fabs(KappaBias-rnd) > KappaBiasError) //to limit extraction at +/- one sigma
