...
last_prompt_run = 277148
last_run = 277148 #last DCS run or last analyzed run
...
Prompt_ll          = LumiList('/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions16/13TeV/Cert_%i-%i_13TeV_PromptReco_Collisions16_JSON%s.txt' % (first_run, last_prompt_run, prompt_version))
PromptMuonsOnly_ll = LumiList('/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions16/13TeV/Cert_%i-%i_13TeV_PromptReco_Collisions16_JSON_MuonPhys%s.txt' % (first_run, last_prompt_run, prompt_version))
...
all_ll_names = ['DCSOnly', 'Run2015', 'Run2016MuonsOnly']
