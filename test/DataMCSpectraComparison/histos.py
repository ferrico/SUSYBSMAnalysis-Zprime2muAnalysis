...
process.GlobalTag.globaltag = '92X_dataRun2_Prompt_v4' # 2017 Data # change also BELOW (line ~497)
...
def for_data(process):
    ...
    process.GlobalTag.globaltag ='92X_dataRun2_Prompt_v4' # 2017 Data # change also BELOW (line ~48)
    ntuplify(process)
