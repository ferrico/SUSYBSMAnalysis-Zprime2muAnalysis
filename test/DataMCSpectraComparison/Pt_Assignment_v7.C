...
//   float gen_lep_pt[2];
  ...
  float met_pt;
	...
	int count_assignment_DATA_till400[8];
	int count_assignment_DATA_400to600[8];
	int count_assignment_DATA_above600[8];
	...
	TH2F* Phi_bin_46 = new TH2F("Check #phi bin", "Check #phi bin", 40, 0, 0.8, 80, 0, 0.8);
	TH2F* Phi_bin_6 = new TH2F("Check #phi bin", "Check #phi bin", 40, 0, 0.8, 80, 0, 0.8);
					...
					prev_event = event;
     				...
     				if (
   						 ...
   						 && vertex_chi2 < 20
     						...
     						ZPrime = lep_1 + lep_2;
     						PickyDimuon_MC->Fill(ZPrime.M(),  weight[j]); PickyDimuon_MC_clear->Fill(ZPrime.M(),  weight[j]); 
							DimuonTuneP_vs_Picky->Fill(ZPrime.M(), dil_mass);
     						...
     						ZPrime = lep_1 + lep_2;
     						DYTDimuon_MC->Fill(ZPrime.M(),  weight[j]); DYTDimuon_MC_clear->Fill(ZPrime.M(),  weight[j]); 
							...
							lep_2.SetPtEtaPhiM(lep_tk_pt[1], lep_tk_eta[1], lep_tk_phi[1], 0.105);			
     						ZPrime = lep_1 + lep_2;
     						TrackerDimuon_MC->Fill(ZPrime.M(),  weight[j]); TrackerDimuon_MC_clear->Fill(ZPrime.M(),  weight[j]); 
...
//      								if(i != 7) count_assignment_MC_till400[i][j-14]++;
		     						...
		     						if(lepton_pt[h][i] < 400){
										if(lep_phi[h] > 0 && lep_phi[h] < 0.8) Phi_bin->Fill(lep_phi[h], gen_lep_phi[h]);
				     					...
				     					eta_GEN_till400_clear->Fill(fabs(gen_lep_eta[h]),  weight[j]);
				     					phi_GEN_till400_clear->Fill(gen_lep_phi[h],  weight[j]);
										...
										if(lep_phi[h] > 0 && lep_phi[h] < 0.8) Phi_bin_46->Fill(lep_phi[h], gen_lep_phi[h]);
				     					...
				     					eta_GEN_400to600_clear->Fill(fabs(gen_lep_eta[h]),  weight[j]);
				     					phi_GEN_400to600_clear->Fill(gen_lep_phi[h],  weight[j]);
										...
										if(lep_phi[h] > 0 && lep_phi[h] < 0.8) Phi_bin_6->Fill(lep_phi[h], gen_lep_phi[h]);
				     					...
				     					eta_GEN_above600_clear->Fill(fabs(gen_lep_eta[h]),  weight[j]);
				     					phi_GEN_above600_clear->Fill(gen_lep_phi[h],  weight[j]);
	     							}
...
//      						std::cout<<"-"<<std::endl;
		 ...
		 for(int i = 0; i < 8; i++){
			 if(j > 39){
				pt_MC_clear[i]->SetFillColor(kGreen-6);
				pt_MC_clear[i]->SetLineColor(kGreen-6);
				eta_MC_clear[i]->SetFillColor(kGreen-6);
				eta_MC_clear[i]->SetLineColor(kGreen-6);
				phi_MC_clear[i]->SetFillColor(kGreen-6);
				phi_MC_clear[i]->SetLineColor(kGreen-6);
				eta_MC_till400_clear[i]->SetFillColor(kGreen-6);
				eta_MC_till400_clear[i]->SetLineColor(kGreen-6);
				eta_MC_400to600_clear[i]->SetFillColor(kGreen-6);
				eta_MC_400to600_clear[i]->SetLineColor(kGreen-6);
				eta_MC_above600_clear[i]->SetFillColor(kGreen-6);
				eta_MC_above600_clear[i]->SetLineColor(kGreen-6);
				phi_MC_till400_clear[i]->SetFillColor(kGreen-6);
				phi_MC_till400_clear[i]->SetLineColor(kGreen-6);
				phi_MC_400to600_clear[i]->SetFillColor(kGreen-6);
				phi_MC_400to600_clear[i]->SetLineColor(kGreen-6);
				phi_MC_above600_clear[i]->SetFillColor(kGreen-6);
				phi_MC_above600_clear[i]->SetLineColor(kGreen-6);
			 }
			 if(j > 30 and j < 39){
...
// 				phi_MC_clear[i]->SetMarkerColor(3);
				eta_MC_till400_clear[i]->SetFillColor(3);
				eta_MC_till400_clear[i]->SetLineColor(3);
				eta_MC_400to600_clear[i]->SetFillColor(3);
				eta_MC_400to600_clear[i]->SetLineColor(3);
				eta_MC_above600_clear[i]->SetFillColor(3);
				eta_MC_above600_clear[i]->SetLineColor(3);
				phi_MC_till400_clear[i]->SetFillColor(3);
				phi_MC_till400_clear[i]->SetLineColor(3);
				phi_MC_400to600_clear[i]->SetFillColor(3);
				phi_MC_400to600_clear[i]->SetLineColor(3);
...
// 				phi_MC_clear[i]->SetMarkerColor(kGreen+3);
				eta_MC_till400_clear[i]->SetFillColor(kGreen+3);
				eta_MC_till400_clear[i]->SetLineColor(kGreen+3);
				eta_MC_400to600_clear[i]->SetFillColor(kGreen+3);
				eta_MC_400to600_clear[i]->SetLineColor(kGreen+3);
				eta_MC_above600_clear[i]->SetFillColor(kGreen+3);
				eta_MC_above600_clear[i]->SetLineColor(kGreen+3);
				phi_MC_till400_clear[i]->SetFillColor(kGreen+3);
				phi_MC_till400_clear[i]->SetLineColor(kGreen+3);
				phi_MC_400to600_clear[i]->SetFillColor(kGreen+3);
				phi_MC_400to600_clear[i]->SetLineColor(kGreen+3);
			 ...
			 if(j > 27 && j < 30){
				...
				eta_MC_till400_clear[i]->SetFillColor(kRed+3);
				eta_MC_till400_clear[i]->SetLineColor(kRed+3);
				eta_MC_400to600_clear[i]->SetFillColor(kRed+3);
				eta_MC_400to600_clear[i]->SetLineColor(kRed+3);
				eta_MC_above600_clear[i]->SetFillColor(kRed+3);
				eta_MC_above600_clear[i]->SetLineColor(kRed+3);
				phi_MC_till400_clear[i]->SetFillColor(kRed+3);
				phi_MC_till400_clear[i]->SetLineColor(kRed+3);
				phi_MC_400to600_clear[i]->SetFillColor(kRed+3);
				phi_MC_400to600_clear[i]->SetLineColor(kRed+3);
			 ...
			 if(j > 25 && j < 28){
				...
				eta_MC_till400_clear[i]->SetFillColor(2);
				eta_MC_till400_clear[i]->SetLineColor(2);
				eta_MC_400to600_clear[i]->SetFillColor(2);
				eta_MC_400to600_clear[i]->SetLineColor(2);
				eta_MC_above600_clear[i]->SetFillColor(2);
				eta_MC_above600_clear[i]->SetLineColor(2);
				phi_MC_till400_clear[i]->SetFillColor(2);
				phi_MC_till400_clear[i]->SetLineColor(2);
				phi_MC_400to600_clear[i]->SetFillColor(2);
				phi_MC_400to600_clear[i]->SetLineColor(2);
			 ...
			 if(j > 20 && j < 26){
				...
				eta_MC_till400_clear[i]->SetFillColor(kRed-10);
				eta_MC_till400_clear[i]->SetLineColor(kRed-10);
				eta_MC_400to600_clear[i]->SetFillColor(kRed-10);
				eta_MC_400to600_clear[i]->SetLineColor(kRed-10);
				eta_MC_above600_clear[i]->SetFillColor(kRed-10);
				eta_MC_above600_clear[i]->SetLineColor(kRed-10);
				phi_MC_till400_clear[i]->SetFillColor(kRed-10);
				phi_MC_till400_clear[i]->SetLineColor(kRed-10);
				phi_MC_400to600_clear[i]->SetFillColor(kRed-10);
				phi_MC_400to600_clear[i]->SetLineColor(kRed-10);
			 ...
			 if(j > 15 && j < 21){
				...
				eta_MC_till400_clear[i]->SetFillColor(4);
				eta_MC_till400_clear[i]->SetLineColor(4);
				eta_MC_400to600_clear[i]->SetFillColor(4);
				eta_MC_400to600_clear[i]->SetLineColor(4);
				eta_MC_above600_clear[i]->SetFillColor(4);
				eta_MC_above600_clear[i]->SetLineColor(4);
				phi_MC_till400_clear[i]->SetFillColor(4);
				phi_MC_till400_clear[i]->SetLineColor(4);
				phi_MC_400to600_clear[i]->SetFillColor(4);
				phi_MC_400to600_clear[i]->SetLineColor(4);
			 ...
			 if(j == 14 || j == 15){
				...
				eta_MC_till400_clear[i]->SetFillColor(kBlue+2);
				eta_MC_till400_clear[i]->SetLineColor(kBlue+2);
				eta_MC_400to600_clear[i]->SetFillColor(kBlue+2);
				eta_MC_400to600_clear[i]->SetLineColor(kBlue+2);
				eta_MC_above600_clear[i]->SetFillColor(kBlue+2);
				eta_MC_above600_clear[i]->SetLineColor(kBlue+2);
				phi_MC_till400_clear[i]->SetFillColor(kBlue+2);
				phi_MC_till400_clear[i]->SetLineColor(kBlue+2);
				phi_MC_400to600_clear[i]->SetFillColor(kBlue+2);
				phi_MC_400to600_clear[i]->SetLineColor(kBlue+2);
		 ...
		 if(j > 39){
			Dimuon_MC_clear->SetFillColor(kGreen-6);
			Dimuon_MC_clear->SetLineColor(kGreen-6);
			PickyDimuon_MC_clear->SetFillColor(kGreen-6);
			PickyDimuon_MC_clear->SetLineColor(kGreen-6);
			DYTDimuon_MC_clear->SetFillColor(kGreen-6);
			DYTDimuon_MC_clear->SetLineColor(kGreen-6);
			TrackerDimuon_MC_clear->SetFillColor(kGreen-6);
			TrackerDimuon_MC_clear->SetLineColor(kGreen-6);
			pt_GEN_clear->SetFillColor(kGreen-6);
			pt_GEN_clear->SetLineColor(kGreen-6);
			eta_GEN_till400_clear->SetFillColor(kGreen-6);
			eta_GEN_till400_clear->SetLineColor(kGreen-6);
			phi_GEN_till400_clear->SetFillColor(kGreen-6);
			phi_GEN_till400_clear->SetLineColor(kGreen-6);
			eta_GEN_400to600_clear->SetFillColor(kGreen-6);
			eta_GEN_400to600_clear->SetLineColor(kGreen-6);
			phi_GEN_400to600_clear->SetFillColor(kGreen-6);
			phi_GEN_400to600_clear->SetLineColor(kGreen-6);
			eta_GEN_above600_clear->SetFillColor(kGreen-6);
			eta_GEN_above600_clear->SetLineColor(kGreen-6);
			phi_GEN_above600_clear->SetFillColor(kGreen-6);
			phi_GEN_above600_clear->SetLineColor(kGreen-6);
		 }	
		 if(j > 30 and j < 39){
			Dimuon_MC_clear->SetFillColor(3);
			Dimuon_MC_clear->SetLineColor(3);
			PickyDimuon_MC_clear->SetFillColor(3);
			PickyDimuon_MC_clear->SetLineColor(3);
			DYTDimuon_MC_clear->SetFillColor(3);
			DYTDimuon_MC_clear->SetLineColor(3);
			TrackerDimuon_MC_clear->SetFillColor(3);
			TrackerDimuon_MC_clear->SetLineColor(3);
			pt_GEN_clear->SetFillColor(3);
			pt_GEN_clear->SetLineColor(3);
			eta_GEN_till400_clear->SetFillColor(3);
			eta_GEN_till400_clear->SetLineColor(3);
			phi_GEN_till400_clear->SetFillColor(3);
			phi_GEN_till400_clear->SetLineColor(3);
			eta_GEN_400to600_clear->SetFillColor(3);
			eta_GEN_400to600_clear->SetLineColor(3);
			phi_GEN_400to600_clear->SetFillColor(3);
			phi_GEN_400to600_clear->SetLineColor(3);
			eta_GEN_above600_clear->SetFillColor(3);
			eta_GEN_above600_clear->SetLineColor(3);
			phi_GEN_above600_clear->SetFillColor(3);
			phi_GEN_above600_clear->SetLineColor(3);
		 }		 
		 if(j == 30 || j == 39){
			Dimuon_MC_clear->SetFillColor(kGreen+3);
			Dimuon_MC_clear->SetLineColor(kGreen+3);
			PickyDimuon_MC_clear->SetFillColor(kGreen+3);
			PickyDimuon_MC_clear->SetLineColor(kGreen+3);
			DYTDimuon_MC_clear->SetFillColor(kGreen+3);
			DYTDimuon_MC_clear->SetLineColor(kGreen+3);
			TrackerDimuon_MC_clear->SetFillColor(kGreen+3);
			TrackerDimuon_MC_clear->SetLineColor(kGreen+3);
			pt_GEN_clear->SetFillColor(kGreen+3);
			pt_GEN_clear->SetLineColor(kGreen+3);
			eta_GEN_till400_clear->SetFillColor(kGreen+3);
			eta_GEN_till400_clear->SetLineColor(kGreen+3);
			phi_GEN_till400_clear->SetFillColor(kGreen+3);
			phi_GEN_till400_clear->SetLineColor(kGreen+3);
			eta_GEN_400to600_clear->SetFillColor(kGreen+3);
			eta_GEN_400to600_clear->SetLineColor(kGreen+3);
			phi_GEN_400to600_clear->SetFillColor(kGreen+3);
			phi_GEN_400to600_clear->SetLineColor(kGreen+3);
			eta_GEN_above600_clear->SetFillColor(kGreen+3);
			eta_GEN_above600_clear->SetLineColor(kGreen+3);
			phi_GEN_above600_clear->SetFillColor(kGreen+3);
			phi_GEN_above600_clear->SetLineColor(kGreen+3);

		 }
		 if(j > 27 && j < 30){
			Dimuon_MC_clear->SetFillColor(kRed+3);
			Dimuon_MC_clear->SetLineColor(kRed+3);
			PickyDimuon_MC_clear->SetFillColor(kRed+3);
			PickyDimuon_MC_clear->SetLineColor(kRed+3);
			DYTDimuon_MC_clear->SetFillColor(kRed+3);
			DYTDimuon_MC_clear->SetLineColor(kRed+3);
			TrackerDimuon_MC_clear->SetFillColor(kRed+3);
			TrackerDimuon_MC_clear->SetLineColor(kRed+3);
			pt_GEN_clear->SetFillColor(kRed+3);
			pt_GEN_clear->SetLineColor(kRed+3);
			eta_GEN_till400_clear->SetFillColor(kRed+3);
			eta_GEN_till400_clear->SetLineColor(kRed+3);
			phi_GEN_till400_clear->SetFillColor(kRed+3);
			phi_GEN_till400_clear->SetLineColor(kRed+3);
			eta_GEN_400to600_clear->SetFillColor(kRed+3);
			eta_GEN_400to600_clear->SetLineColor(kRed+3);
			phi_GEN_400to600_clear->SetFillColor(kRed+3);
			phi_GEN_400to600_clear->SetLineColor(kRed+3);
			eta_GEN_above600_clear->SetFillColor(kRed+3);
			eta_GEN_above600_clear->SetLineColor(kRed+3);
			phi_GEN_above600_clear->SetFillColor(kRed+3);
			phi_GEN_above600_clear->SetLineColor(kRed+3);
		 }
		 if(j > 25 && j < 28){
			Dimuon_MC_clear->SetFillColor(2);
			Dimuon_MC_clear->SetLineColor(2);
			PickyDimuon_MC_clear->SetFillColor(2);
			PickyDimuon_MC_clear->SetLineColor(2);
			DYTDimuon_MC_clear->SetFillColor(2);
			DYTDimuon_MC_clear->SetLineColor(2);
			TrackerDimuon_MC_clear->SetFillColor(2);
			TrackerDimuon_MC_clear->SetLineColor(2);
			pt_GEN_clear->SetFillColor(2);
			pt_GEN_clear->SetLineColor(2);
			eta_GEN_till400_clear->SetFillColor(2);
			eta_GEN_till400_clear->SetLineColor(2);
			phi_GEN_till400_clear->SetFillColor(2);
			phi_GEN_till400_clear->SetLineColor(2);
			eta_GEN_400to600_clear->SetFillColor(2);
			eta_GEN_400to600_clear->SetLineColor(2);
			phi_GEN_400to600_clear->SetFillColor(2);
			phi_GEN_400to600_clear->SetLineColor(2);
			eta_GEN_above600_clear->SetFillColor(2);
			eta_GEN_above600_clear->SetLineColor(2);
			phi_GEN_above600_clear->SetFillColor(2);
			phi_GEN_above600_clear->SetLineColor(2);	
		 }
		 if(j > 20 && j < 26){
			Dimuon_MC_clear->SetFillColor(kRed-10);
			Dimuon_MC_clear->SetLineColor(kRed-10);
			PickyDimuon_MC_clear->SetFillColor(kRed-10);
			PickyDimuon_MC_clear->SetLineColor(kRed-10);
			DYTDimuon_MC_clear->SetFillColor(kRed-10);
			DYTDimuon_MC_clear->SetLineColor(kRed-10);
			TrackerDimuon_MC_clear->SetFillColor(kRed-10);
			TrackerDimuon_MC_clear->SetLineColor(kRed-10);
			pt_GEN_clear->SetFillColor(kRed-10);
			pt_GEN_clear->SetLineColor(kRed-10);
			eta_GEN_till400_clear->SetFillColor(kRed-10);
			eta_GEN_till400_clear->SetLineColor(kRed-10);
			phi_GEN_till400_clear->SetFillColor(kRed-10);
			phi_GEN_till400_clear->SetLineColor(kRed-10);
			eta_GEN_400to600_clear->SetFillColor(kRed-10);
			eta_GEN_400to600_clear->SetLineColor(kRed-10);
			phi_GEN_400to600_clear->SetFillColor(kRed-10);
			phi_GEN_400to600_clear->SetLineColor(kRed-10);
			eta_GEN_above600_clear->SetFillColor(kRed-10);
			eta_GEN_above600_clear->SetLineColor(kRed-10);
			phi_GEN_above600_clear->SetFillColor(kRed-10);
			phi_GEN_above600_clear->SetLineColor(kRed-10);
		 }
		 if(j > 15 && j < 21){
			Dimuon_MC_clear->SetFillColor(4);
			Dimuon_MC_clear->SetLineColor(4);
			PickyDimuon_MC_clear->SetFillColor(4);
			PickyDimuon_MC_clear->SetLineColor(4);
			DYTDimuon_MC_clear->SetFillColor(4);
			DYTDimuon_MC_clear->SetLineColor(4);
			TrackerDimuon_MC_clear->SetFillColor(4);
			TrackerDimuon_MC_clear->SetLineColor(4);
			pt_GEN_clear->SetFillColor(4);
			pt_GEN_clear->SetLineColor(4);
			eta_GEN_till400_clear->SetFillColor(4);
			eta_GEN_till400_clear->SetLineColor(4);
			phi_GEN_till400_clear->SetFillColor(4);
			phi_GEN_till400_clear->SetLineColor(4);
			eta_GEN_400to600_clear->SetFillColor(4);
			eta_GEN_400to600_clear->SetLineColor(4);
			phi_GEN_400to600_clear->SetFillColor(4);
			phi_GEN_400to600_clear->SetLineColor(4);
			eta_GEN_above600_clear->SetFillColor(4);
			eta_GEN_above600_clear->SetLineColor(4);
			phi_GEN_above600_clear->SetFillColor(4);
			phi_GEN_above600_clear->SetLineColor(4);
		 }
		 if(j == 14 || j == 15){
			Dimuon_MC_clear->SetFillColor(kBlue+2);
			Dimuon_MC_clear->SetLineColor(kBlue+2);
			PickyDimuon_MC_clear->SetFillColor(kBlue+2);
			PickyDimuon_MC_clear->SetLineColor(kBlue+2);
			DYTDimuon_MC_clear->SetFillColor(kBlue+2);
			DYTDimuon_MC_clear->SetLineColor(kBlue+2);
			TrackerDimuon_MC_clear->SetFillColor(kBlue+2);
			TrackerDimuon_MC_clear->SetLineColor(kBlue+2);
			pt_GEN_clear->SetFillColor(kBlue+2);
			pt_GEN_clear->SetLineColor(kBlue+2);
			eta_GEN_till400_clear->SetFillColor(kBlue+2);
			eta_GEN_till400_clear->SetLineColor(kBlue+2);
			phi_GEN_till400_clear->SetFillColor(kBlue+2);
			phi_GEN_till400_clear->SetLineColor(kBlue+2);
			eta_GEN_400to600_clear->SetFillColor(kBlue+2);
			eta_GEN_400to600_clear->SetLineColor(kBlue+2);
			phi_GEN_400to600_clear->SetFillColor(kBlue+2);
			phi_GEN_400to600_clear->SetLineColor(kBlue+2);
			eta_GEN_above600_clear->SetFillColor(kBlue+2);
			eta_GEN_above600_clear->SetLineColor(kBlue+2);
			phi_GEN_above600_clear->SetFillColor(kBlue+2);
			phi_GEN_above600_clear->SetLineColor(kBlue+2);			
		 }
...
//      						std::cout<<"-"<<std::endl;
    ...
    for(int i = 0; i <30; i++){ // samples
     ...
     printf("    MC         --->  %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", tot_till[1], tot_till[2], tot_till[3], tot_till[4],tot_till[5], tot_till[7]);
 	 printf("  DATA         --->  %15d\t%15d\t%15d\t%15d\t%15d\t\t|%15d\n", count_assignment_DATA_till400[1], count_assignment_DATA_till400[2], count_assignment_DATA_till400[3], count_assignment_DATA_till400[4], count_assignment_DATA_till400[5], count_assignment_DATA_till400[7]);
 	 printf(" ----------------------------------------------------------------------------------------------------------------------------------- \n");
     ...
     printf("   MC (%%)      ---> %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", (float)tot_till[1]/TOT_MC, (float)tot_till[2]/TOT_MC,(float)tot_till[3]/TOT_MC, (float)tot_till[4]/TOT_MC, (float)tot_till[5]/TOT_MC, (float)tot_till[7]/TOT_MC);
 	 printf(" DATA (%%)      ---> %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", (float)count_assignment_DATA_till400[1]/TOT_DATA, (float)count_assignment_DATA_till400[2]/TOT_DATA, (float)count_assignment_DATA_till400[3]/TOT_DATA, (float)count_assignment_DATA_till400[4]/TOT_DATA, (float)count_assignment_DATA_till400[5]/TOT_DATA, (float)count_assignment_DATA_till400[7]/TOT_DATA);
...
/*     std::cout<<"\n\n\t\t\t\tMC"<<std::endl;
    ...
    for(int i = 0; i < 30; i++){ // samples
     ...
     printf("    MC         --->  %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", tot_middle[1], tot_middle[2], tot_middle[3], tot_middle[4],tot_middle[5], tot_middle[7]);
 	 printf("  DATA         --->  %15d\t%15d\t%15d\t%15d\t%15d\t\t|%15d\n", count_assignment_DATA_400to600[1], count_assignment_DATA_400to600[2], count_assignment_DATA_400to600[3], count_assignment_DATA_400to600[4], count_assignment_DATA_400to600[5], count_assignment_DATA_400to600[7]);
 	 printf(" ----------------------------------------------------------------------------------------------------------------------------------- \n");
 	 printf("  MC TOTAL = %10.3f\nDATA TOTAL = %10d\n", TOT_MC, TOT_DATA); 	 
 	 printf(" ----------------------------------------------------------------------------------------------------------------------------------- \n");
     printf("   MC (%%)      ---> %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", (float)tot_middle[1]/TOT_MC, (float)tot_middle[2]/TOT_MC,(float)tot_middle[3]/TOT_MC, (float)tot_middle[4]/TOT_MC, (float)tot_middle[5]/TOT_MC, (float)tot_middle[7]/TOT_MC);
 	 printf(" DATA (%%)      ---> %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", (float)count_assignment_DATA_400to600[1]/TOT_DATA, (float)count_assignment_DATA_400to600[2]/TOT_DATA, (float)count_assignment_DATA_400to600[3]/TOT_DATA, (float)count_assignment_DATA_400to600[4]/TOT_DATA, (float)count_assignment_DATA_400to600[5]/TOT_DATA, (float)count_assignment_DATA_400to600[7]/TOT_DATA);
    ...
    for(int i = 0; i < 30; i++){ // samples
     ...
     printf("    MC         --->  %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", tot_above[1], tot_above[2], tot_above[3], tot_above[4],tot_above[5], tot_above[7]);
 	 printf("  DATA         --->  %15d\t%15d\t%15d\t%15d\t%15d\t\t|%15d\n", count_assignment_DATA_above600[1], count_assignment_DATA_above600[2], count_assignment_DATA_above600[3], count_assignment_DATA_above600[4], count_assignment_DATA_above600[5], count_assignment_DATA_above600[7]);
 	 printf(" ----------------------------------------------------------------------------------------------------------------------------------- \n");
 	 printf("  MC TOTAL = %10.3f\nDATA TOTAL = %10d\n", TOT_MC, TOT_DATA); 	 
 	 printf(" ----------------------------------------------------------------------------------------------------------------------------------- \n");
     printf("   MC (%%)      ---> %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", (float)tot_above[1]/TOT_MC, (float)tot_above[2]/TOT_MC,(float)tot_above[3]/TOT_MC, (float)tot_above[4]/TOT_MC, (float)tot_above[5]/TOT_MC, (float)tot_above[7]/TOT_MC);
 	 printf(" DATA (%%)      ---> %15.3f\t%15.3f\t%15.3f\t%15.3f\t%15.3f\t\t|%15.3f\n", (float)count_assignment_DATA_above600[1]/TOT_DATA, (float)count_assignment_DATA_above600[2]/TOT_DATA, (float)count_assignment_DATA_above600[3]/TOT_DATA, (float)count_assignment_DATA_above600[4]/TOT_DATA, (float)count_assignment_DATA_above600[5]/TOT_DATA, (float)count_assignment_DATA_above600[7]/TOT_DATA);
