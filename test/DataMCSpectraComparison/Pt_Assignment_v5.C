...
/*	std::vector<<TString>> samples;
	samples.push_back("dyInclusive50");
    samples.push_back("qcd80to120");
    samples.push_back("qcd120to170");
    samples.push_back("qcd170to300");
    samples.push_back("qcd300to470");
    samples.push_back("qcd470to600");
    samples.push_back("qcd600to800");
    samples.push_back("qcd800to1000");
    samples.push_back("qcd1000to1400");
    samples.push_back("qcd1400to1800");
    samples.push_back("qcd1800to2400");
    samples.push_back("qcd2400to3200");
    samples.push_back("qcd3200");
    samples.push_back("Wjets",
    samples.push_back("Wantitop");
    samples.push_back("tW");, 
    samples.push_back("ttbar_lep50to500");
    samples.push_back("ttbar_lep_500to800");
    samples.push_back("ttbar_lep_800to1200");
    samples.push_back("ttbar_lep_1200to1800");
    samples.push_back("ttbar_lep1800toInf");                            
    samples.push_back("WWinclusive");
    samples.push_back("WW200to600");
    samples.push_back("WW600to1200");
    samples.push_back("WW1200to2500");
    samples.push_back("WW2500");
    samples.push_back("ZZ");
    samples.push_back("WZ");
    samples.push_back("ZZ_ext");
    samples.push_back("WZ_ext");
    samples.push_back("dy50to120");
    samples.push_back("dy120to200");
    samples.push_back("dy200to400");
    samples.push_back("dy400to800");
    samples.push_back("dy800to1400");
    samples.push_back("dy1400to2300");
    samples.push_back("dy2300to3500");
    samples.push_back("dy3500to4500");
    samples.push_back("dy4500to6000");
                    */
				 ...
				 /////// CON E SENZA VTX CUT ///////
					...
					prev_event = event;
     				...
     				if (
     					...
     					)  Dimuon_DATA->Fill(dil_mass,  weight[j]);
