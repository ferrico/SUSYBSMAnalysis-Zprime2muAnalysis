...
#         do('crab status -d crab_TuneP_Assignment/crab_ana_datamc_%(name)s*' %sample)
...
#         do('crab report -d crab_TuneP_Assignment/crab_ana_datamc_%(name)s* ' % sample)
...
#         do('crab resubmit -d crab_TuneP_Assignment/crab_ana_datamc_%(name)s* ' % sample)
    ...
    for sample in samples:
        ...
        do('crab kill -d crab_TuneP_Assignment/crab_ana_datamc_%(name)s* ' % sample)
...
#         do('crab getoutput -d crab_TuneP_Assignment/crab_ana_datamc_%(name)s* --checksum=no ' % sample)
