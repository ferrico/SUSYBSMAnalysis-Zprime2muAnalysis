...
class Drawer:
    ...
    def __init__(self, options):
        ...
        # ASCII table.
        self.quantities_to_compare = ['DimuonMassVertexConstrained','DimuonMassVertexConstrained_bb', 'DimuonMassVertexConstrained_be']
#         'DileptonMass', 'DimuonMassVertexConstrained', 'DimuonMassVtx_chi2',
#         								'NTkLayers', 'NTkHits', 'NPxHits', 
#         								'DimuonMuonPtErrOverPt', 'DileptonPt',
#         								'NVertices',
...
#         self.mass_ranges_for_table = [(50,120), (120,200), (200,400), (400,800), (800,)]#(600,900), (900,1300), (1300,1800), (1800,), (120,), (200,), (400,), (600,),]
        self.mass_ranges_for_table = [(120,400), (400,600), (600,900), (900,1300), (1300,1800), (1800,)]
        ...
        if options.for_rescale_factors:
            ...
            self.mass_ranges_for_table = [(50,120)]
    ...
    def get_rebin_factor(self, dilepton, quantity_to_compare):
        ...
        if dilepton == 'MuonsSameSign':
            if quantity_to_compare == 'DileptonMass':
                return 5
        if quantity_to_compare in ['DileptonMass', 'DimuonMassVertexConstrained', 'DimuonMassVertexConstrained_bb', 'DimuonMassVertexConstrained_be', 'DileptonPt', 'LeptonPt']:
            return 20
#            return 50
...
#        if quantity_to_compare != 'DimuonMassVtxConstrainedLog':
    ...
    def go(self):
        for quantity_to_compare in self.quantities_to_compare:
            ...
            if quantity_to_compare != 'DileptonMass':
                cutsets = ['Our2012', 'Our2016']#, 'OurMuPrescaledNew', 'OurMuPrescaled2012']
            else:
...
#                    dileptons = self.dileptons
                ...
                for dilepton in dileptons:
                    ...
                    for cumulative in (False, True):
                        ...
                        if not cumulative and quantity_to_compare in ['DimuonMassVertexConstrained', 'DimuonMassVertexConstrained_bb', 'DimuonMassVertexConstrained_be'] and self.print_table:
