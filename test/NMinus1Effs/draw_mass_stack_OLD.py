...
def draw_mass_stack_test(tag, printStats, lumi, do_tight=False):
    ...
    psn = 'plots/mass_stack/'
    if tag:
        psn = 'plots/mass_stack/%s'%tag
    ...
    # All MC samples
    samples = [WWinclusive, WW200to600, WW600to1200, WW1200to2500, WW2500, 
    						WZ, ZZ,
    						Wantitop, tW, Wjets, 
    						ttbar_lep, #ttbar_lep_800to1200, ttbar_lep_1200to1800, ttbar_lep1800toInf
#     						ttbar_lep50to500
#     						ttbar_lep50to800
#     						qcd50to80, 
    ...
    #print mass_range
#     mass_range = [60,120,200,400,800,1400,2300,3500,4500,6000]
