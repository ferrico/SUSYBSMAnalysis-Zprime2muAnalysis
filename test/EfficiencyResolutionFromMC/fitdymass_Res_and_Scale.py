...
hists_DY_systematic = []
if '_bb' in variable:
	hists_dir_DY_systematic = '../DataMCSpectraComparison/mc/DY_BB_resolution/'
else:
	hists_dir_DY_systematic = '../DataMCSpectraComparison/mc/DY_BE_scale/'
...
legend = ROOT.TLegend(0.3, 0.8, 0.6, 0.95)
legend.AddEntry(htot_DY, "MC", "l")
if '_bb' in variable:
	legend.AddEntry(htot_DY_systematic, "MC - DY resolution", "l")
else:
	legend.AddEntry(htot_DY_systematic, "MC - DY scale", "l")
legend.Draw()
...
#     ps.c.Update()
    ...
    htot_DY.SetMinimum(10e-5)
    htot_DY.SetMaximum(10e5)
    if sovra:
...
#     ss.SetOptFit(11111)
    htot_DY_systematic.SetMinimum(10e-5)
    htot_DY_systematic.SetMaximum(10e5)
#     ps.c.Update()
...
print " ------------------------------------------------------------------------- Passo al Draw "
print variable, high,int_lumi, sovra, use_non_dy, rebin#, bias
#fit_it(400,2000)
