...
def make_mc_hist(do_non_dy,doPI,int_lumi,low,high,rebin,hists_dir,category):
    ...
    for sample in dy_samples:
        ...
        h = f.Get(category).Get('DimuonMassVertexConstrained').Clone('%s' % sample.name)
        h.Rebin(rebin)
...
def addPI(histDY,rebin,low,high,category,int_lumi):
    ...
    lg.Draw()
    if category == 'Our2012MuonsPlusMuonsMinusBarrelHistos':
        title='Barrel-Barrel'
        savename = 'BB'
    elif category == 'Our2012MuonsPlusMuonsMinusPositiveHistos':
        title='Barrel-Positive Endcap'
        savename = 'BEp'
    elif category == 'Our2012MuonsPlusMuonsMinusNegativeHistos':
...
if __name__=='__main__':
    ...
    for category in ['Our2012MuonsPlusMuonsMinusBarrelHistos',
                     'Our2012MuonsPlusMuonsMinusNegativeHistos',
                     'Our2012MuonsPlusMuonsMinusPositiveHistos',
                     'Our2012MuonsPlusMuonsMinusHistos']:
        print category
        if category=='Our2012MuonsPlusMuonsMinusBarrelHistos':
            name = 'BB'
        if category=='Our2012MuonsPlusMuonsMinusPositiveHistos':
            name = 'BEp'
        if category=='Our2012MuonsPlusMuonsMinusNegativeHistos':
            name = 'BEn'
        if category=='Our2012MuonsPlusMuonsMinusHistos':
            name = 'All'
