...
#        (pars2,_,_) = doFitGeneric(hist,output,rapidity,"crystal")
    ...
    for k,f in enumerate(param): 
        ...
        if "Sigma" in f.GetName():
            f.GetYaxis().SetRangeUser(0,0.25)
...
#     parser.add_argument("-i","--ifile", dest="inputfile",default="/afs/cern.ch/work/f/ferrico/private/ZPrime_code/CMSSW_8_0_21/src/SUSYBSMAnalysis/Zprime2muAnalysis/test/EfficiencyResolutionFromMC/mc/effres.root", help='Input filename')
    parser.add_argument("-o","--ofolder",dest="output", default="./plots/Check_Code", help='folder name to store results')
