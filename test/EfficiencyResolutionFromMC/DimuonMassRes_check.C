...
// 		weight[i] = LUMINOSITY * sigma[i] / events[i];
	...
	double mass;
	double rdil;
	TH2F* DileptonMassResVMass_2d = new TH2F("(dil. mass - gen dil. mass)/(gen dil. mass)", "(dil. mass - gen dil. mass)/(gen dil. mass)", binnum, MASS_BINS, 200, -1., 1.0);
	TH2F* DileptonMassResVMass_2d_BB = new TH2F("(dil. mass - gen dil. mass)/(gen dil. mass): BB", "(dil. mass - gen dil. mass)/(gen dil. mass): BB", binnum, MASS_BINS, 200,-1., 1.0);
	TH2F* DileptonMassResVMass_2d_BE = new TH2F("(dil. mass - gen dil. mass)/(gen dil. mass): BE+EE", "(dil. mass - gen dil. mass)/(gen dil. mass): BE+EE", binnum, MASS_BINS, 200, -1., 1.0);
	TH2F* DileptonMassResVMass_2d_EE = new TH2F("(dil. mass - gen dil. mass)/(gen dil. mass: EE)", "(dil. mass - gen dil. mass)/(gen dil. mass): EE", binnum, MASS_BINS, 200, -1., 1.0);
