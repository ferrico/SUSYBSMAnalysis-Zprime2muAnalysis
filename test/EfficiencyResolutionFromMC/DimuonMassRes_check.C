...
// 	TString longstring_2;
    for(int i = 0; i < funct->GetNpar()+1; i++){
 	 ...
 	 if(save){	
 	if(i==1)
 		canvas->Print("./Check_Resolution_Code_2016_Tracker/Split_2categorie/BB_resolution.pdf[");
	canvas->Print("./Check_Resolution_Code_2016_Tracker/Split_2categorie/BB_resolution.pdf");
...
// 	TString longstring_2;
 ...
 if(save){
 	if(i==1)
 		canvas->Print("./Check_Resolution_Code_2016_Tracker/Split_2categorie/BE_resolution.pdf[");
	canvas->Print("./Check_Resolution_Code_2016_Tracker/Split_2categorie/BE_resolution.pdf");
 ...
 if(save){	 	
 	if(i==1)
 		canvas->Print("./Check_Resolution_Code_2016_Tracker/Split_2categorie/EE_resolution.pdf[");
	canvas->Print("./Check_Resolution_Code_2016_Tracker/Split_2categorie/EE_resolution.pdf");
...
//  legend_3->AddEntry(res_be,"BE category: elsewhere", "lep");
 legend_3->Draw(); 
 if(save){
 c1->Print("./Check_Resolution_Code_2016_Tracker/Split_2categorie/Resolution.png");
 c1->Print("./Check_Resolution_Code_2016_Tracker/Split_2categorie/Resolution.pdf");
	}
